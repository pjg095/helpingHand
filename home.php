					...
					<div class="col-lg-10 mx-auto">
						<div class="owl-testimonial owl-carousel owl-theme">
							<div class="item">
								<div class="slider-info mt-lg-4 mt-3">
									<div class="img-circle">
										<img src="assets/images/f2.jpeg" class="img-fluid rounded" alt="client image">
									</div>
							...
							<div class="item">
								<div class="slider-info mt-lg-4 mt-3">
									<div class="img-circle">
										<img src="assets/images/f4.jpeg" class="img-fluid rounded" alt="client image">
									</div>
									<div class="message">Though I am unable to donate funds, I will donate my time as joining volunteer in NGO...</div>
									<div class="name">- purvadeep</div>
								</div>
							</div>
							<div class="item">
								<div class="slider-info mt-lg-4 mt-3">
									<div class="img-circle">
										<img src="assets/images/f3.jpeg" class="img-fluid rounded" alt="client image">
									</div>
							...
							<div class="item">
								<div class="slider-info mt-lg-4 mt-3">
									<div class="img-circle">
										<img src="assets/images/f6.jpeg" class="img-fluid rounded" alt="client image">
									</div>
